...
namespace EMS.Migrations
{
    ...
    [Migration("20250504232643_change-fitnessInfo-to-int")]
    partial class changefitnessInfotoint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Entities.ContactUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EMS.Entities.FitnessInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FitnessInfo");
                });

            modelBuilder.Entity("EMS.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EMS.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EMS.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EMS.Entities.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EMS.Entities.Workout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EMS.Entities.AppUsers", b =>
                {
            ...
            modelBuilder.Entity("EMS.Entities.CartItem", b =>
                {
                    b.HasOne("EMS.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("EMS.Entities.FitnessInfo", b =>
                {
                    b.HasOne("EMS.Entities.Workout", "Workout")
                        .WithMany()
            ...
            modelBuilder.Entity("EMS.Entities.OrderItem", b =>
                {
                    b.HasOne("EMS.Entities.Order", null)
                        .WithMany("OrderItems")
